...
# print("author: " + str(myvar1["author"] + " id: " + str(myvar1["famous works"]["novels"][0]["id"]) + " title: " + myvar1["famous works"]["novels"][0]["title"]))

print(myvar1["author"])
print()
# 1print(myvar1["famous works"]["novels"])

for f in myvar1["famous works"]["novels"]:
	print("Id: " + str(f["id"]) + " title: " + f["title"])
print()
print()